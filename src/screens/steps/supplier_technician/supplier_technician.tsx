...
const Supplier_Technician: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (response) {
                ...
                setSupplier(await supplierService.getSuppliersByType(5));
            }else{
                navigate('/login');
            }
        }catch(e){
    ...
    const handleNext = async () => {
        const response = await supplierService.createUserTech(comboSelectedId);
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div className="form-check mt-4">
                                            ...
                                            Conclui todos os itens da de etapa
                                            de aquisição
                                            </label>
                                        </div>
                                        ...
                                        <div className="form-check mt-4">
                                            ...
                                            />
                                            <label className="form-check-label" htmlFor="purchaseCheckbox">
                                            Meu ponto está adequado para
                                            receber a montagem das máquinas
                                            </label>
                                        </div>
